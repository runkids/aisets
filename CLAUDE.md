...
- **FilterRail on every data view:** Browse, Duplicates, Lint — all data-heavy pages must have a FilterRail sidebar with a Project section at minimum. Views with their own FilterRail render as `<> <Rail/> <div content-scroll/> </>` and must NOT be inside App.tsx's shared scroll div.
