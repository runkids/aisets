...
export function AIOperationsCard({
  ...
  useEffect(() => {
    ...
    aiTagActivity.providerName,
    aiTagActivity.modelName,
    aiTagActivity.errors,
  ]);
  ...
  useEffect(() => {
    ...
    vlmOcrActivity.providerName,
    vlmOcrActivity.modelName,
    vlmOcrActivity.errors,
  ]);
