...
import { batchActionButtonClassName } from "@/features/optimize/optimizeTypes";
import {
  Button,
  ConfirmDialog,
  Modal,
...
import {
  defaultTagViewLocale,
  normalizeDisplayLocale,
  tagViewLocaleOptions,
} from "./tagViewLocale";
...
export function TagsView({
  ...
  useEffect(() => {
    // Keep the visible locale in sync with app language and available translations.
