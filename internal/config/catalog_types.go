...
type CatalogNearDuplicatePair struct {
	scanner.NearDuplicate
	LeftItem  *scanner.AssetItem `json:"leftItem,omitempty"`
	RightItem *scanner.AssetItem `json:"rightItem,omitempty"`
}
