...
type canvasCardSnapshot struct {
	...
	Shapes         []canvasShapeSnapshot `json:"shapes,omitempty"`
	ShapeCount     int                   `json:"shapeCount,omitempty"`
}

type canvasShapeSnapshot struct {
	ID          string             `json:"id"`
	Kind        string             `json:"kind"`
	...
	Points      []canvasShapePoint `json:"points,omitempty"`
}

type canvasShapePoint struct {
	X float64 `json:"x"`
	Y float64 `json:"y"`
}
